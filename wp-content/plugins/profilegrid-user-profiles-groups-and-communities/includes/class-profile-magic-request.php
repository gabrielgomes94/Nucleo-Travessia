...
//put your code here
	...
	public function profile_magic_get_user_attachment($value)
	{
		...
		foreach($values as $fileid)
		{
			...
			$attachment_html .='<span class="pm-attachment-title"><a href="'.wp_get_attachment_url( $fileid ).'">'.get_the_title( $fileid ).'</a></span>';
		}
	...
	public function profile_magic_check_is_group_leader($userid)
	{
                $dbhandler = new PM_DBhandler;
