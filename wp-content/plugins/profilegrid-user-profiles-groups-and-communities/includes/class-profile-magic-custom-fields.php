    ...
    public function pm_get_custom_form_field_user_email($row, $value = '', $textdomain = '') {
        ...
        <div class="pm-col">
            ...
            <div class="pm-field-input pm_email pm_user_email pm_required">
                <input title="<?php echo esc_attr($row->field_desc); ?>" type="email" class="<?php if (!empty($field_options)) echo esc_attr($field_options['css_class_attribute']); ?>" maxlength="<?php if (!empty($field_options)) echo esc_attr($field_options['maximum_length']); ?>" value="<?php echo esc_attr($value); ?>" id="<?php echo esc_attr($row->field_key); ?>" name="<?php echo esc_attr($row->field_key); ?>" placeholder="<?php if (!empty($field_options)) echo esc_attr($field_options['place_holder_text']); ?>" onkeyup="pm_frontend_check_useremail()" onblur="pm_frontend_check_useremail()">
                <div class="errortext" style="display:none;"></div>
