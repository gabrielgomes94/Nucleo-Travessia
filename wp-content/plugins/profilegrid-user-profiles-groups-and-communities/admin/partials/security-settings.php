  ...
  <form name="pm_security_settings" id="pm_security_settings" method="post">
    ...
    <div class="content">
      ...
      <div class="uimrow">
        ...
        <div class="uimnote"><?php _e('Required to make reCAPTCHA work. You can generate site key from','profile-grid');?> <a target="blank" class="rm_help_link" href="https://www.google.com/recaptcha/"><?php _e("here",'profile-grid');?></a></div>
      </div>
      ...
      <div class="uimrow">
        ...
        <div class="uimnote"><?php _e('Change this setting if your reCAPTCHA is not working as expected.','profile-grid');?></div>
      </div>
