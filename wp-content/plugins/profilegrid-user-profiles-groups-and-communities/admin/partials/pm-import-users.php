    ...
    <div class="content">
     ...
     <div class="uimrow">
      ...
      <div class="uimrow">
        ...
        <div class="uimnote"><?php _e('Step 3: Select the column seperator in your sheer. If you are not sure, keep it as comma(,) the most common CSV selector.','profile-grid');?></div>
      </div>
