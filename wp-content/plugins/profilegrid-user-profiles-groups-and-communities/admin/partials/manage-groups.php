...
<div class="pmagic"> 
  ...
  <div class="pmagic-cards">
    ...
    <div class="pm-card">
      ...
      <div class="pm-last-submission"> (...) <?php _e("and",'profile-grid');?> <a href="admin.php?page=pm_user_manager&gid=<?php echo $group->id; ?>"><span class="card-submissions"><?php echo $total_users-3;?> </span> </a><?php _e("more",'profile-grid');?> </div>
      <?php endif;?>
