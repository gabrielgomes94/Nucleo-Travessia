    ...
    <div class="content">
      ...
      <div class="uimrow">
        ...
        <div class="uiminput">
          ...
          <div class="uimnote"><?php _e('A group leader is mentioned on the Group page prominently. The leader also has special previlidges to moderate the group.','profile-grid');?></div>
      </div>
      <div class="childfieldsrow" id="groupleaderhtml" style=" <?php  if(!empty($row) && $row->is_group_leader==1){echo 'display:block;';} else { echo 'display:none;';} ?>">
        <div class="uimrow">
          ...
          <div class="uiminput <?php if(!empty($row) && $row->is_group_leader==1){echo 'pm_required pm_group_leader_name';}?>">
            ...
            <div class="uimnote"><?php _e('Select from exsiting users. Start typing for realtime search.','profile-grid');?></div>
        </div>
