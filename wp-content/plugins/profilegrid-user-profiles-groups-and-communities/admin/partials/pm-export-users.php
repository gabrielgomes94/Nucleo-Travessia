  ...
  <form name="pm_export_users" id="pm_export_users" method="post">
    ...
    <div class="content">
     ...
     <div class="uimrow">
        ...
        <div class="uimnote"><?php _e('Step 3: Select the seperator to seperate columns in your CSV file. "," is most common seperator and MS Excel, Apple Numbers and most other popular spreadsheet programs will open it normally. But if you want to import CSV in a specific app, do check what it recommends for seperator.','profile-grid');?></div>
      </div>
