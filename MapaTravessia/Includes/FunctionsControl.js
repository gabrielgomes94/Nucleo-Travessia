...
function LogoControl(controlDiv, map) {
    ...
    var ControlImage = document.createElement('div');
	// Set CSS to control the box that contains the Logo
    ControlImage.style.paddingLeft = '2px';
    ControlImage.style.paddingRight = '2px';
    ControlImage.style.paddingTop = '2px';
    ControlImage.style.paddingBottom = '2px';
	ControlImage.innerHTML = '<a href="http://nucleotravessia.unifei.edu.br" target="_blank"> <img src="Icons_Images/travessia.png" width= 55px> </a>';
